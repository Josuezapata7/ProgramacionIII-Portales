...
public class Plataforma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegistro.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 16)); // NOI18N
        btnRegistro.setForeground(new java.awt.Color(54, 76, 98));
        btnRegistro.setText("REGISTRO ALUMNOS");
        ...
        pnlMenu.add(btnRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(201, 138, -1, 27));

        lblRegistro.setBackground(new java.awt.Color(204, 204, 204));
        lblRegistro.setOpaque(true);
        pnlMenu.add(lblRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 125, 8));
        ...
        pnlMenu.add(btnPagos, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, 86, -1));
        ...
        pnlMenu.add(lblPagos, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 170, 125, 8));
        ...
        pnlMenu.add(btnNotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, 87, -1));
        ...
        pnlMenu.add(lblNotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 170, 125, 8));
        ...
        pnlMenu.add(btnCronograma, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 140, 142, -1));
        ...
        pnlMenu.add(lblCronograma, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 170, 125, 8));
        ...
        btnMaestros.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 16)); // NOI18N
        btnMaestros.setForeground(new java.awt.Color(54, 76, 98));
        btnMaestros.setText("REGISTRO MAESTROS");
        btnMaestros.setContentAreaFilled(false);
        btnMaestros.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnMaestros.setFocusable(false);
        btnMaestros.setPreferredSize(new java.awt.Dimension(100, 27));
        btnMaestros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMaestrosActionPerformed(evt);
            }
        });
        pnlMenu.add(btnMaestros, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 140, 190, -1));

        lblMaestros.setBackground(new java.awt.Color(204, 204, 204));
        lblMaestros.setOpaque(true);
        lblMaestros.setPreferredSize(new java.awt.Dimension(100, 0));
        pnlMenu.add(lblMaestros, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 170, 125, 9));
        ...
        getContentPane().add(jPanel_Plataforma, java.awt.BorderLayout.CENTER);
    ...
    private void btnCronogramaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCronogramaActionPerformed
        ...
        lblRegistro.setBackground(new Color(color[0], color[1], color[2]));
        lblPagos.setBackground(new Color(color[0], color[1], color[2]));
        lblNotas.setBackground(new Color(color[0], color[1], color[2]));
        lblMaestros.setBackground(new Color(color[0], color[1], color[2]));
        pnlBody.removeAll();
        pnlBody.repaint();
        pnlBody.revalidate();
    ...
    private void btnRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistroActionPerformed
        lblRegistro.setBackground(new Color(0, 204, 106));
    ...
    private void btnMaestrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaestrosActionPerformed
        lblMaestros.setBackground(new Color(0, 204, 106));
