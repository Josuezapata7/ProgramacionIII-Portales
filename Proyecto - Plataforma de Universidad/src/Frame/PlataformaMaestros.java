 ...
 * @author hp
 */
public class PlataformaMaestros extends javax.swing.JFrame {
 boolean maximized = true;
    int[] color = {204, 204, 204};
   
    public PlataformaMaestros() {
       initComponents();
    ...
    private void initComponents() {
        ...
        pnlMenu.add(btnNotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 87, -1));
        ...
        pnlMenu.add(lblNotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 125, 8));
        ...
        pnlMenu.add(btnCronograma, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 142, -1));
        ...
        pnlMenu.add(lblCronograma, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 170, 125, 8));
    ...
    private void btnMaximizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaximizeActionPerformed
        if (maximized) {
            ...
            PlataformaMaestros.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            PlataformaMaestros.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlataformaMaestros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlataformaMaestros().setVisible(true);
            }
        });
    }
